...
export const RolePromptModal: React.FC<RolePromptModalProps> = ({
  ...
  return (
    <ModalPortal>
      ...
      >
        <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl border border-amber-900/10 space-y-5 relative overscroll-contain animate-in zoom-in-95 duration-200 my-auto">
          <button
            onClick={onClose}
